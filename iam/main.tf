...
resource "aws_iam_user_group_membership" "storage_admin3" {
  user = aws_iam_user.stadmin3.name
  groups = [
    aws_iam_group.storage-admin.name
  ]
}
...
resource "aws_iam_user_group_membership" "compute-admin3" {
  user = aws_iam_user.compadmin3.name
  groups = [
    aws_iam_group.compute-admin.name
  ]
}
...
resource "aws_iam_user" "stadmin3" {
  name = "stadmin3"
}
...
resource "aws_iam_user" "compadmin3" {
  name = "compadmin3"
}
